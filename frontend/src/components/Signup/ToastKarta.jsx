    ...
    >
      ...
      <div className="flex border-l border-gray-200 ">
        <Button
          ...
          className="w-full arimo border border-transparent bg-cardbg  rounded-none rounded-r-xl  p-4 flex items-center justify-center text-sm font-medium text-hoverblack hover:text-hoverblack focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          QuickFix
        </Button>
      </div>
