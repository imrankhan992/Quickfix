...
const ServiceProviderPreviousOrders = () => {
      ...
      <div className="flex relative">
        ...
        <main className="text-primarycolor w-full">
          ...
          <div className="px-8 py-6">
            ...
            <div className="text-red-500 flex items-center py-6"><p>Data not avaliable.</p></div>
          </div>
...
export default ServiceProviderPreviousOrders;
