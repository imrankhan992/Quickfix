...
const UserProfile = () => {
  ...
  console.log(serviceProvider, "this is user prfile");
  const { id } = useParams();
    ...
    <div className="container mx-auto p-5">
      ...
      <div className="flex flex-col  bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="mt-4 flex flex-col items-start">
          ...
          <p className="text-gray-700 mt-2">{serviceProvider?.experience}</p>
        </div>

        <div className="mt-4 text-start max-w-[60%]">
          <h3 className="text-lg font-semibold">Description</h3>
          <p className="text-gray-700 mt-2">{serviceProvider?.description}</p>
        </div>
